...
export default function Form2553() {
    const serviceInfo = useServiceInfo("Form 2553");
    ...
    return <AdminCommonPaymentInfo name={"Tax Election with Form 2553"} submitFormData={submitFormData} serviceInfo={serviceInfo} state={state} setState={setState} error={error} setError={setError} serviceState={false} allState={allState} country={country} />;
}
